...
export function ApplicationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        const msg = (data && (data.message || data.error)) || "Failed to submit. Please try again.";
        throw new Error(msg);
      }
  ...
  return (
    <section id="apply" className="px-4 sm:px-6 py-16 md:py-24 bg-gradient-to-b from-background to-secondary/30">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="relative space-y-4 sm:space-y-5 bg-card border border-border/60 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 shadow-2xl shadow-foreground/5">
            ...
            <div className="space-y-2">
              <Label htmlFor="businessType" className="text-xs sm:text-sm font-medium text-foreground">Business Type</Label>
              <Input
                id="businessType"
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
              <div className="space-y-2">
                <Label htmlFor="budget" className="text-xs sm:text-sm font-medium text-foreground">Budget Range</Label>
                <Select
              ...
              <div className="space-y-2">
                <Label htmlFor="timeline" className="text-xs sm:text-sm font-medium text-foreground">When to start?</Label>
                <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="reason" className="text-xs sm:text-sm font-medium text-foreground">Why do you want to build this store now?</Label>
              <Textarea
                id="reason"
