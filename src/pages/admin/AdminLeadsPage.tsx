        ...
        <aside className="hidden md:flex w-64 border-r bg-white/60 backdrop-blur">
          <div className="w-full p-5">
            ...
            <div className="mt-6 space-y-2">
              <div className="rounded-lg px-3 py-2 bg-accent font-medium">
                Leads
              </div>
            </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col md:flex-row gap-3">
                <Input
                  ...
                  placeholder="Search name / whatsapp / business / budget / timeline..."
                  className="bg-white"
                />
                <Button
                  onClick={() => {
                  ...
                  <tbody>
                    {rows.map((r) => (
                      <tr key={r.id} className="border-t align-top">
                        ...
                        <td className="p-3">{r.business_type || "-"}</td>
                        <td className="p-3">{r.budget_range || "-"}</td>
                        <td className="p-3">{r.start_timeline || "-"}</td>
                        <td className="p-3">{trunc(r.motivation, 70)}</td>
